 ...
 */
public class SlowArcadeJoystickDrive extends CommandBase {
   ...
   */
  public SlowArcadeJoystickDrive(DriveSubsystem subsystem, DoubleSupplier forward, DoubleSupplier rotation) {
    m_drive = subsystem;
    m_forward = forward;
    m_rotation = rotation;
